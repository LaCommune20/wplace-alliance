(() => {
  ...
  function installZoneDetails() {
    ...
    style.textContent = `
      ...
      .zone-overall button{padding:4px 7px!important;border-radius:8px!important;font-size:8px!important;background:#1b1b1b!important;color:#888!important}
      ...
      .zone-focus{padding:4px 7px!important;border-radius:8px!important;font-size:8px!important;background:#1b1b1b!important;color:#aaa!important}
      ...
      #zone-details-close{width:22px;height:22px;border:0;background:transparent;color:#777;font-size:18px;line-height:20px;padding:0;cursor:pointer;border-radius:8px}#zone-details-close:hover{background:rgba(255,255,255,.06);color:#fff}
      ...
      #zone-details-actions{display:flex;gap:4px;margin-top:7px}#zone-details-actions button{flex:1;border:1px solid rgba(255,255,255,.10);background:#1d1d1d;color:#bbb;padding:6px 7px;cursor:pointer;font-size:8px;border-radius:8px!important}#zone-details-actions button:hover{background:#292929;color:#fff}
